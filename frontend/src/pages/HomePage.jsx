          ...
          <div className="bg-white w-full max-w-md rounded-2xl border border-slate-200/80 shadow-xl shadow-slate-900/5 overflow-hidden">
            ...
            <div className="px-6 py-2 space-y-6 max-h-[55vh] overflow-y-auto custom-scrollbar">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Say a bit about what you're hoping to trade…"
                  className="w-full text-sm bg-slate-50 border border-slate-200 rounded-xl px-3 py-2.5 outline-none focus:border-slate-400 focus:bg-white transition-all text-slate-800 resize-none"
                />
              </div>
            </div>
            ...
            <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 text-sm font-medium text-white bg-slate-900 rounded-xl hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors inline-flex items-center gap-1.5"
              >
